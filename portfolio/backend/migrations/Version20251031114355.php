 ...
 */
final class Version20251031114355 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tag (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL COMMENT \'Название тега (например: PHP, JavaScript, DevOps и т.д.)\', description LONGTEXT DEFAULT NULL COMMENT \'Описание тега (необязательно)\', create_at DATETIME NOT NULL COMMENT \'Дата и время создания тега(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_389B7835E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
